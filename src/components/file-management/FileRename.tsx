...
export const FileRename: React.FC<FileRenameProps> = ({
    ...
    const validateName = (name: string): string | null => {
        ...
        if (idx > 0) {
            ...
            if (
                currentExt &&
                newExt.toLowerCase() !== currentExt.toLowerCase()
            ) {
    ...
    const handleRename = async () => {
        ...
        try {
            // Prepare baseName for API and finalName for UI (API preserves extension)
            const currentExt = getExt(currentName);
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Enter a new name for the file. The file extension will
                        be preserved.
                    </DialogDescription>
                </DialogHeader>
