...
import { DatasetService, type DatasetData } from "../../lib/datasetApi";
...
const DatasetDataViewer: React.FC<DatasetDataViewerProps> = ({ datasetId }) => {
    ...
    const loadData = async (skip = 0, pageLimit = 50) => {
        try {
            setLoading(true);
            setError(null);
            ...
            setError(
                err.response?.data?.message || "Failed to load dataset data"
            );
        } finally {
            setLoading(false);
        }
            ...
            <Card>
                <CardContent className="p-8 text-center">
                    ...
                    <p className="text-gray-600">
                        This dataset appears to be empty or the data is not
                        available.
                    </p>
                </CardContent>
            </Card>
