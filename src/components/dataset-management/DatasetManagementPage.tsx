...
import DatasetConverter from "./DatasetConverter.tsx";
import DatasetDetails from "./DatasetDetails.tsx";
import DatasetDataViewer from "./DatasetDataViewer.tsx";
...
const DatasetManagementPage: React.FC<DatasetManagementPageProps> = ({
    className,
    preselectedFileId,
    initialTab = "list",
}) => {
