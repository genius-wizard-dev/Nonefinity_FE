        ...
        persist(
            ...
            getChats: async (skip: number = 0, limit: number = 100) => {
                ...
                try {
                    ...
                    if (state.chats.length > 0 && isSamePage && isFresh) {
                        ...
                        (async () => {
                            try {
                                ...
                                console.warn(
                                    "Background revalidation (chats) failed:",
                                    e
                                );
                            }
                        })();
                    ...
                    set((s) => ({
                        _pendingRequests: new Map(s._pendingRequests || new Map()).set(cacheKey, requestPromise)
                    }));
                    ...
                    if (cached && isFresh) {
                        ...
                        (async () => {
                            try {
                                ...
                                console.warn(
                                    "Background revalidation (messages) failed:",
                                    e
                                );
                            }
                        })();
