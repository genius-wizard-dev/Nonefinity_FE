    ...
    return (
        <div className="p-6 space-y-6">
            ...
            <Alert>
                ...
                <AlertDescription>
                    <strong>API Key Security:</strong> API keys provide full
                    access to your account. Never share your API keys publicly
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <Input
                                id="expires"
                                type="number"
                                placeholder="1-30 days (default 30)"
                                min="1"
                                max="30"
                            ...
                            <p className="text-xs text-muted-foreground mt-1">
                                If left empty, the key will expire in 30 days.
            ...
            <Dialog open={showAPIKeyDialog} onOpenChange={setShowAPIKeyDialog}>
                <DialogContent className="max-w-2xl">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Save this API key - you won't be able to see it
                            again!
                        </DialogDescription>
                    </DialogHeader>
                    {createdAPIKey && (
                        <div className="space-y-4">
                            <Alert variant="destructive">
                                <AlertCircle className="h-4 w-4" />
                                <AlertDescription>
                                    This is the only time you will see this API
                                    key. Make sure to save it in a secure
                                    location!
                                </AlertDescription>
                            </Alert>
