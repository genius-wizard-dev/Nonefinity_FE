    ...
    const handleCreate = async (event: React.FormEvent) => {
        ...
        if (formData.expires_in_days) {
            ...
            if (parsed > MAX_EXPIRY_DAYS) {
                toast.info(
                    `Expiration limited to ${MAX_EXPIRY_DAYS} days per policy.`
                );
            }
        }
    ...
    return (
        <div className="p-6 space-y-6">
            <div className="flex justify-between items-start">
                <div>
                    ...
                    <p className="text-muted-foreground mt-2">
                        API base URL auto-resolves in the SDK — you only need an
                        API key now.
                    </p>
                </div>
            ...
            <Alert className="bg-muted/60">
                ...
                <AlertDescription>
                    Keys grant full access. Store them in environment variables
                    and rotate them regularly. Keys can live for up to
            ...
            >
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Keys inherit full workspace access. Only share with
                            trusted systems.
                        </DialogDescription>
                    </DialogHeader>
                    <form onSubmit={handleCreate} className="space-y-4">
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-muted-foreground">
                                Use something recognizable so you know where
                                this key is used.
                            </p>
                        </div>
                        <div className="space-y-2">
                            ...
                            />
                            <p className="text-xs text-muted-foreground">
                                Leave blank for no expiration. Otherwise, keys
                                cannot exceed {MAX_EXPIRY_DAYS} days.
                            </p>
                        </div>
                        <DialogFooter>
                            <Button
                    ...
                    <ScrollArea className="max-h-[60vh] pr-4">
                        <div className="space-y-4 pb-4">
                            <Alert variant="destructive">
                                ...
                                <AlertDescription>
                                    Consider a password manager or secure
                                    secrets vault. You cannot recover the full
                                    key later.
                                </AlertDescription>
                            </Alert>
            ...
            >
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This permanently removes the key and cannot be
                            undone.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
            ...
            >
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Revoked keys stop working immediately but remain in
                            your history.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
