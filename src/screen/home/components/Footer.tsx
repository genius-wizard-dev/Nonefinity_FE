            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="lg:col-span-2">
                        <BlurFade delay={0.1} inView>
                            ...
                            <p className="text-gray-400 mb-6 max-w-sm leading-relaxed">
                                Build intelligent AI agents in minutes. Upload
                                files, run SQL queries, create embeddings, and
                                deploy powerful conversational AI with
                ...
                <BlurFade delay={0.7} inView>
                    <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row items-center justify-between text-sm text-gray-400">
                        <div className="mb-4 md:mb-0">
                            © {new Date().getFullYear()} Nonefinity. All rights
                            reserved.
                        </div>
